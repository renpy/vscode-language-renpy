...
export const atlEventName: TokenPattern = {
    patterns: [
        ...
        atlBuildInEvents,
        {
            ...
            token: EntityTokenType.FunctionName, /*entity.name.function.renpy meta.function-call.generic.renpy*/
