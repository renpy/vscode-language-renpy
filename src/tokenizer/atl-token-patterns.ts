...
import { pythonBuiltinExceptions, pythonBuiltinFunctions, pythonBuiltinPossibleCallables, pythonBuiltinTypes, pythonCurlyBraces, pythonEllipsis, pythonExpression, pythonFunctionCall, pythonIllegalNames, pythonIllegalOperator, pythonItemAccess, pythonLineContinuation, pythonList, pythonLiteral, pythonMagicNames, pythonMemberAccess, pythonOddFunctionCall, pythonOperator, pythonPunctuation, pythonRoundBraces, pythonSpecialNames, pythonSpecialVariables } from "./python-token-patterns";
...
export const atl: TokenPattern = {
    debugName: "atl",
    patterns: [/* Items included at the bottom of the file*/]
};
