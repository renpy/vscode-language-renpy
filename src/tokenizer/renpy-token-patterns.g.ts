...
// Last generated: 12/07/2024 18:46:24 (UTC+0)
    ...
    patterns: [
        ...
        },
        {
            ...
            captures: {
                ...
                2: { token: EntityTokenType.TagName, /*entity.name.tag.${2:/downcase}.renpy*/ },
                3: { token: OperatorTokenType.Assignment, /*punctuation.separator.key-value.renpy keyword.operator.assignment.renpy*/ },
                4: { token: MetaTokenType.ConstantCaps, /*support.constant.property-value.renpy constant.other.placeholder.tags.renpy*/ },
                5: { token: CharacterTokenType.CloseBracket, /*punctuation.definition.tag.end.renpy*/ },
            },
        },
        {
    ...
    patterns: [
        {
            ...
            patterns: [
                strings,
                {
                    debugName: "show.patterns![0].patterns![1]",
            ...
            patterns: [
                {
                    ...
                    token: KeywordTokenType.Show, /*keyword.show.renpy*/
                    match: /(show)/g,
                },
                {
                    debugName: "window.patterns![0].patterns![1]",

                    token: KeywordTokenType.Hide, /*keyword.hide.renpy*/
                    match: /(hide)/g,
                },
                whitespace,
                simpleExpression,
    ...
    patterns: [
        {
            ...
            end: /(?=\b(behind|expression|with|zorder)\b|#)|$/gm,
            patterns: [
                strings,
                {
                    debugName: "hide.patterns![0].patterns![1]",
...
export const call: TokenPattern = {
    ...
    patterns: [
        ...
        callFrom,
        {
            debugName: "call.patterns![3]",

            token: MetaTokenType.FromClause, /*meta.from.clause.renpy*/
            begin: /(?<=call[ \t]+)(screen)\b/dg,
            beginCaptures: {
            ...
            patterns: [
                {
                    debugName: "call.patterns![3].patterns![0]",
