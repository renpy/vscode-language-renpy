...
import { MetaTokenType, CharacterTokenType, EntityTokenType, OperatorTokenType, KeywordTokenType } from "./renpy-tokens";
    ...
    patterns: [
        {
            ...
            match: /\b(?<!\.)(is)\b[ \t]*(\w*)/dg,
            captures: {
                1: { token: OperatorTokenType.Is, /*keyword.is.renpy keyword.operator.logical.is.renpy*/ },
