...
RenpyPatterns.conditionals.captures![2].patterns!.splice(0, 0, PythonPatterns.expression);
...
export { AtlPatterns, RenpyPatterns, StylePatterns, PythonPatterns, ScreenPatterns };