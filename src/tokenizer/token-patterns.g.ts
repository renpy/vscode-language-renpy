...
RenpyPatterns.menu.beginCaptures![3].patterns!.push(PythonPatterns.oddFunctionCall);
...
export { ScreenPatterns, PythonPatterns, AtlPatterns, RenpyPatterns, StylePatterns };